const MemberCard = ({name, position,image}) => {
  return (
    <div className=" max-w-full">
      <div
        className="relative overflow-hidden bg-white border border-orange-400 hover:border-2 hover:border-blue-950 rounded mb-12 hover-grayscale-0 wow fadeInUp cursor-pointer shadow-md hover:shadow-xl"
        data-wow-duration="1s"
        title="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;"
      >
